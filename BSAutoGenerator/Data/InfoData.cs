...
namespace BSAutoGenerator.Data
{
    internal class InfoData
    {
        [JsonConstructor]
        public InfoData(string _version, string _songName, string _songSubName, string _songAuthorName, string _levelAuthorName, float _beatsPerMinute, float _songTimeOffset, float _shuffle,
            ...
            List<DifficultyBeatmapSets> _difficultyBeatmapSets, CustomDataInfo _customData)
        {
            ...
            {
                this._customData = new(new("BSAutoGenerator", new()));
            }
        ...
        public string _levelAuthorName { get; set; } = "BSAutoGenerator";
        [JsonInclude]
