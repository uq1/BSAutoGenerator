...
namespace BSAutoGenerator.Info
{
    internal static class Enumerator
    {
        ...
        internal static class PossibleBluePlacement
        {
            ...
            { new int[] { 3, 0 }, new int[] { 3, 1 }, new int[] { 3, 2 } }, // Up

            //new int[][] { new int[] { 3, 0 }, new int[] { 3, 1 }, new int[] { 2, 0 }, new int[] { 1, 0 } },  // Down (no inverted for now)
            new int[][] { new int[] { 3, 0 }, new int[] { 3, 1 }, new int[] { 2, 0 } },  // Down (no inverted for now)

            //new int[][] { new int[] { 2, 0 }, new int[] { 1, 0 }, new int[] { 0, 0 }, new int[] { 0, 1 } }, // Left
            new int[][] { new int[] { 2, 0 }, new int[] { 1, 0 }, new int[] { 0, 0 } }, // Left
